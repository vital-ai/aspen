...
public class AssignPageRankValuesTask extends ModelTrainingTask {

	public String inputDatasetName;
	public String outputDatasetName;
	
	public AssignPageRankValuesTask(AspenModel model,
	...
	public List<String> getRequiredParams() {
		return Arrays.asList(inputDatasetName, CalculatePageRankValuesTask.NODE_URI_2_RANK);
	}
