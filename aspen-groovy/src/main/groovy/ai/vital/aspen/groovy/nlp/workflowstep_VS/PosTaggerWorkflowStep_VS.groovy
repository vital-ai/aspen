...
public class PosTaggerWorkflowStep_VS extends WorkflowStepV2Impl<NLPServerConfig> {

	public final static StepName POSTAGGER_VS = new StepName("postagger_vs");
	
	private final static Logger log = LoggerFactory.getLogger(PosTaggerWorkflowStep_VS.class);
