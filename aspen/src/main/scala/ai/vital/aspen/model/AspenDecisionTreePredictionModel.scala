...
object AspenDecisionTreePredictionModel {
...
@SerialVersionUID(1L)
class AspenDecisionTreePredictionModel extends AspenDecisionTreeBaseModel {

  def supportedType(): String = {
    return AspenDecisionTreePredictionModel.spark_decision_tree_prediction
  }
