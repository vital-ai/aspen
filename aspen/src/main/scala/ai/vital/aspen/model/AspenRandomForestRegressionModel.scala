...
object AspenRandomForestRegressionModel {
...
@SerialVersionUID(1L)
class AspenRandomForestRegressionModel extends AspenRandomForestBaseModel {

  def supportedType(): String = {
    AspenRandomForestRegressionModel.spark_randomforest_regression
  }
