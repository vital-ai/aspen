...
object LogisticRegressionPredictionModel {
  val spark_logistic_regression_prediction = "spark-logistic-regression-prediction"  
}

@SerialVersionUID(1L)
class LogisticRegressionPredictionModel extends PredictionModel {
  ...
  def supportedType(): String = {
    LogisticRegressionPredictionModel.spark_logistic_regression_prediction
  }
}