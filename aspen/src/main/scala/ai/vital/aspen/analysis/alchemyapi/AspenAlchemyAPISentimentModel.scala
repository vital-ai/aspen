...
object AspenAlchemyAPISentimentModel {
  
    val alchemy_api_sentiment = "alchemy-api-sentiment";


}

@SerialVersionUID(1L)
class AspenAlchemyAPISentimentModel extends PredictionModel {
  ...
  var client : HttpClient = null 
	...
	def supportedType(): String = {
			AspenAlchemyAPISentimentModel.alchemy_api_sentiment
	}
    ...
    /*
{
    ...
    val docSentiment = response.get("docSentiment").asInstanceOf[Map[String, Object]]
    
    val outPrediction = new SentimentPrediction()
