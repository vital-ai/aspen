...
import org.apache.spark.mllib12.tree.configuration.BoostingStrategy
import org.apache.spark.mllib12.tree.configuration.EnsembleCombiningStrategy.Sum
import org.apache.spark.mllib12.tree.impl.TimeTracker
import org.apache.spark.mllib12.tree.model.{WeightedEnsembleModel, DecisionTreeModel}
...
object GradientBoosting extends Logging {
   ...
   * Method to train a gradient boosting model.
   *
   * Note: Using [[org.apache.spark.mllib12.tree.GradientBoosting$#trainRegressor]]
   *       is recommended to clearly specify regression.
   *       Using [[org.apache.spark.mllib12.tree.GradientBoosting$#trainClassifier]]
   *       is recommended to clearly specify regression.
   *
   * @param input Training dataset: RDD of [[org.apache.spark.mllib.regression.LabeledPoint]].
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib12.tree.GradientBoosting$#train]]
   */
  def train(
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib12.tree.GradientBoosting$#trainClassifier]]
   */
  def trainClassifier(
      input: JavaRDD[LabeledPoint],
      boostingStrategy: BoostingStrategy): WeightedEnsembleModel = {
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib12.tree.GradientBoosting$#trainRegressor]]
   */
  def trainRegressor(
      input: JavaRDD[LabeledPoint],
      boostingStrategy: BoostingStrategy): WeightedEnsembleModel = {
