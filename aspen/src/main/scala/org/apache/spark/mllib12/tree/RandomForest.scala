...
import org.apache.spark.mllib12.tree.configuration.EnsembleCombiningStrategy.Average
import org.apache.spark.mllib12.tree.configuration.Strategy
import org.apache.spark.mllib12.tree.impl.{BaggedPoint, TreePoint, DecisionTreeMetadata, TimeTracker, NodeIdCache }
import org.apache.spark.mllib12.tree.impurity.Impurities
...
object RandomForest extends Serializable with Logging {
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib12.tree.RandomForest$#trainClassifier]]
   */
  def trainClassifier(
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib12.tree.RandomForest$#trainRegressor]]
   */
  def trainRegressor(
      input: JavaRDD[LabeledPoint],
      categoricalFeaturesInfo: java.util.Map[java.lang.Integer, java.lang.Integer],
